...
Apartment.configure do |config|
  ...
  #
 # config.excluded_models = %w{ User  Detail Question Faq}  old
  config.excluded_models = ["User", "Detail", "Question", "Faq"]  
...
Apartment::Elevators::Subdomain.excluded_subdomains = ['www', 'public', 'admin', 'faq', 'help']
